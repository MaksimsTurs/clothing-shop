...
export interface UserExtended extends UserData {
  createdAt: string
  updatedAt: string
}

export interface ProductExtended extends ProductData {
  sectionInfo?: { _id: string, title: string }
}

export interface ProductSectionExtended extends ProductSection {
  products: ProductExtended[]
  expiredDate?: string
}
...
export type CreateNewProduct = {
  ...
  newSection: ProductSectionExtended
}
