...
import NMFilter from './filter'
import NMobileFilter from './mobileFilter'
...
export default function SearchContainer() {
	...
	const usedFilters = {...filterState, page: currPage || 0, category: filterState.category.length > 0 ? filterState.category : categoryTitle ? [categoryTitle] : [] }
