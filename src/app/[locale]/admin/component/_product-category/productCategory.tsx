...
export default function ProductCategory() {
  ...
  const category = DataTool.find({ _id: id }, productCategory) as ProductCategory | undefined
  const categoryProducts = DataTool.findMany<ProductData>({ $in: { _id: category?.productsID || [] } }, products)
  const categoryAction = DataTool.find<ProductAction>({ categoryID: id! }, productAction) as ProductAction | undefined
