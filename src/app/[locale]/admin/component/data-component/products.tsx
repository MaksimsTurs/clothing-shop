...
export default function Products() {
	...
	const { products, adminActionError, isAdminActionLoading } = useSelector<RootState,	AdminInitState>(state => state.admin)
			...
			<table className={scss.data_list_container}>
				...
				<tbody>
					{products.map((product, index) => (
						<tr key={product._id} onClick={() => router.push(`/ru/admin/item/product?id=${product._id}`)}>
