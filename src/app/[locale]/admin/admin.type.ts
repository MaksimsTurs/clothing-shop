...
export type SelectProductProps = {
  ...
  precent: number
  productsID: string[]
  setProductsID: Dispatch<SetStateAction<string[]>>
}
...
export type DataPageProps = {
  ...
  data: any
  title: string
  ignore?: { forData?: string[] }
}

export type ProductFormProps = {
  dispatchFunc?: any
  formWrapperTitle?: string
  productID?: string
  section?: { _id: string, title: string }
}

export type ProductsSectionFormProps = {
  id?: string
  title?: string
  dispatchFunc?: any
...
export type AddProductsSectionData = {
  title: string
  items: string[]
  precent: number
  expiredDate?: string
...
export type AddProductsSectionDataReturn = {
  section: ProductSection
  products: ProductData[]
}

export type EditProductsSectionReturn = {
  newProducts: ProductData[]
  newSection: ProductSection
}